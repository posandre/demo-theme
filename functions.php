...
function demo_theme_scripts() {
	wp_enqueue_style( 'demo-theme-style', get_stylesheet_directory_uri() . '/css/style-main.min.css' , array(), _S_VERSION );
    wp_enqueue_script( 'demo-theme-script', get_stylesheet_directory_uri().'/js/client/site-main.min.js', array('jquery'),  _S_VERSION, true);
