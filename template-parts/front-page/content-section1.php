...
$section1_video_link = demo_theme_get_acf_field('section1_video_link', $post_id, __('https://google.com', 'demo-theme'));
...
<section class="section section-1">
    ...
    <div class="section__video-button section-1__button">
        <a class="section__video-link section-1__link" rel="nofollow" target="_blank" href="<?php esc_attr_e($section1_video_link); ?>"><?php _e('Watch the video', 'demo-theme'); ?></a>
    </div>
    <div class="section__button section-1__button">
        <span><?php _e('Get Reading Flow™', 'demo-theme'); ?></span>
        <a class="section__btn section-1__btn" rel="nofollow" target="_blank" href="<?php esc_attr_e($section1_video_link); ?>"><?php _e('Start Free Trial', 'domo-theme');?></a>
    </div>
