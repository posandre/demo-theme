...
$bottom_text = demo_theme_get_acf_field('section1_bottom_text', $post_id, __('<p><strong>Reading Flow™</strong> works by using a simple cognitive trick — an eye-guiding color gradient — to pull your eyes through long blocks of text, helping improve focus, concentrating and reading speed.</p>
