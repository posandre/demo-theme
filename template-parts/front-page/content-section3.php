...
$title = demo_theme_get_acf_field('section3_title', $post_id, __('Reading Flow™<br> Increases User Engagement', 'demo-theme'));
$subtitle_1 = demo_theme_get_acf_field('section3_subtitle_1', $post_id, __('Metrics that Matter', 'demo-theme'));
$subtitle_2 = demo_theme_get_acf_field('section3_subtitle_2', $post_id, __('Customizable Colors<br> Customizable Accessibility', 'demo-theme'));
